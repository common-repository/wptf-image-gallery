...
mysql_query("INSERT INTO `".$wpdb->prefix."rbt_slides` (`id`, `sliderid`, `date`, `title`, `desc`, `url`) 
...
$description = htmlentities($_POST[description],ENT_COMPAT,'utf-8');
mysql_query("UPDATE `".$wpdb->prefix."rbt_slides` SET `title`='$title', `desc`='$description', `url`='$_POST[upload_image]' WHERE `id`='$_GET[sedit]'");
}
