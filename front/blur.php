...
$color = wptf_image_thumb($row['img'], 'w='.$data['w'].'&h='.$data['h']);
$blur = wptf_image_thumb($row['img'], 'f=8|8|8|8|8|8|8|8|8&w='.$data['w'].'&h='.$data['h']);
$out = $out.'<li id="wptf-img-'.$row['id'].'"><a class="mbox" data-init="'.$mode.'" style="background-image:url(\''.$color.'\')" title="'.$row['title'].'" href="'.$wptf_upload['baseurl'].'/wptf-uploads/'.$row['img'].'"><img src="'.$blur.'" /></a></li>';
++$i;
}
